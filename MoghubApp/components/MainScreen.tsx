...
import { Image, SafeAreaView, ScrollView, Text, TextInput, View, Button } from 'react-native';
      ...
      <SafeAreaView>
        <ScrollView>
          <Image
            ...
            source={require('../images/moghubAppLogo.jpg')}
          />
          <Text style={styles.mainTxt}>MogHub</Text>
          <Text style={styles.slogan}>P u r r f e c t  C o m p a n i o n s</Text>

          <View style={styles.inputFlex}>
            <Text style={styles.enterTxt}>Please enter your pet's name:</Text>
            <TextInput
              style={styles.userInputTxt}
              placeholder="Mog"
              value={petName}
              onChangeText={(newPetName) => setPetName(newPetName)}
            />
          </View>
